...
import '../../../assets/sass/core/components/buttons/_blip.scss'
type Props = {
  className: string
  chartColor: string
  strokeColor: string
    ...
    <div className={`card ${className}`}>
      ...
      <div className={`card-header border-0 py-5 bg-${chartColor}`}>
        <div className='d-flex flex-column justify-content-start'>
          <p className='card-title fw-normal text-white fs-4'>Total Users</p>
          <h3 className='card-title fw-bold text-white mt-1 '>{usersData?.activeUser}</h3>
        </div>
          ...
          <div className='row g-0 mt-18'>
            ...
            {/* <div className='col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7'>
              <div className='d-flex align-items-center'>
                ...
                />
                <h2
                  style={{color: '#152238', marginInlineStart: '1.7rem'}}
                  className='card-title fw-bold mb-0'
                >
                  {usersData?.activeUserToday}
                </h2>
              </div>
              <a
                href='#'
                className='text-warning fw-semobold fs-6 d-flex justify-content-start align-items-center '
              >
                <span className='hint__dot'></span> Active Users
              </a>
            </div> */}
            {/* end::Col */}
            {/* begin::Col */}
